...
public class GroundPlaneUI : MonoBehaviour
{
    ...
    const string CHAIR_PLACEMENT_HINT = "Tap to place Bed";
    const string CHAIR_CONTROLS_WITH_PINCH = "• Touch and drag to move Bed\n• Two fingers to rotate or pinch to scale";
    const string CHAIR_CONTROLS_WITHOUT_PINCH = "• Touch and drag to move Bed\n• Two fingers to rotate";
